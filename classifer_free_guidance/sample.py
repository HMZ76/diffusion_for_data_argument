...
def main():
    ...
    parser.add_argument("--data_root", type=str, default="../val_data/", help="数据根目录（包含example_input_*.npy和example_target_*.npy）")
    ...
    parser.add_argument("--batch_size", type=int, default=32, help="采样batch_size（根据CUDA内存调整）")
